  ...
  return (
    <footer className="bg-[#071426] text-neutral-300 pt-10 sm:pt-14 pb-10 sm:pb-8 border-t border-[#0f2b4c]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div className="flex items-center gap-2 pt-1 sm:pt-2">
              ...
              {whatsappDigits && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => trackContact({ method: 'WhatsApp Footer' })}
                  className="w-8 h-8 rounded-lg bg-[#0b1f3a] border border-[#163761] hover:bg-[#008236] hover:text-white flex items-center justify-center text-neutral-400 transition-colors active:scale-95"
                  title="WhatsApp"
                >
              ...
              {footerSettings?.phone && (
                <div className="flex items-center gap-2.5">
                  ...
                  <a
                    ...
                    onClick={() => trackContact({ method: 'Phone Footer' })}
        ...
        {/* Bottom Bar */}
        <div className="pt-5 sm:pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-neutral-400 font-normal text-center sm:text-left">
          <p>{footerSettings?.copyrightText || '© 2026 WEFT Bangladesh. All rights reserved.'}</p>
          <div className="flex items-center gap-1.5 text-neutral-400">
            <span>Developed by</span>
            <a
              href="https://www.facebook.com/nthropos"
              target="_blank"
              rel="noopener noreferrer"
              className="font-semibold text-white tracking-wide hover:text-[#00B44B] underline decoration-neutral-600 underline-offset-4 hover:decoration-[#00B44B] transition-colors"
            >
              Nthropos
            </a>
          </div>
